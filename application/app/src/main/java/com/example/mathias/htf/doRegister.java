...
public class doRegister extends AsyncTask<ArrayList<String>,String,String> {
    public int statuscode;
    public Context thisContext;
    public Activity thisActivity;
    doRegister(Context context, Activity activity){
...
//        InputStream in = null;
       String result =  postApi(param);

        return result;
    }


    private String postApi(ArrayList<String> param){
...
//            Log.e("Logging",in.toString());
            URL url = new URL("https://htf-mars.azurewebsites.net/api/researcher");
